...
| 5    | 修复VO配置8K输出情况下接入4K HDMI显示器出现驱动异常问题 | 【问题描述】VO配置8K输出情况下接入4K HDMI显示器出现驱动异常问题<br/>【原因分析】驱动没有特殊处理该场景<br/>【解决方法】驱动添加对该场景处理<br/>【主要修改文件】<br/>kernel: drivers/gpu/drm/bridge/synopsys/dw-hdmi-qp.c | 必须更新 |
